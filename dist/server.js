...
/******/ 	var hotCurrentHash = "129f00d708e2fc09d1d0"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mongodb = __webpack_require__(160);
	
	var mongoUrl = process.env.MONGOURL || 'mongodb://localhost:27017/example_app';
	
	var conn = void 0;
	
	var appState = {
	    getConnection: function getConnection() {
	        conn = conn || _mongodb.MongoClient.connect(mongoUrl);
	        return conn;
	    }
	};
			...
			value: function toggle(st) {
				...
				if (st === 'state') {
					...
					var _state3 = this.state,
					    price2 = _state3.price2,
					    description2 = _state3.description2,
					    optionalConsultancy2 = _state3.optionalConsultancy2;
				...
				var handler = StripeCheckout.configure({
					...
					token: function token(_token) {
						...
						fetch('/charge', {
							...
							_this2.setState({ loading2: false });
							if (st === 'state') {
								...
								_this2.setState({ txOk2: true, txMessage2: 'Transazione riuscita, download avviato' });
							}
						}).catch(function (err) {
							_this2.setState({ loading: false });
							_this2.setState({ loading1: false });
							...
							if (st === 'state') {
								...
								_this2.setState({ txOk2: false, txMessage2: err });
							}
	   ...
	   */
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						"div",
						{ className: "mdl-grid", style: { border: '1px solid #ccc!important', borderRadius: '23px' } },
						_react2.default.createElement(
							"div",
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								"Realizzare applicazioni web con interfacce utente scalabili e performanti \xE8 una sfida che gli sviluppatori affrontano da un decennio. React.js \xE8 forse la tecnologia che fino a oggi ha risposto in maniera ..."
							)
						),
						_react2.default.createElement(
							"div",
							{ style: { marginLeft: '50px;' }, className: "mdl-cell mdl-cell--3-col mdl-cell--middle" },
							_react2.default.createElement(
								"p",
								null,
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"div",
							{ className: "mdl-cell mdl-cell--2-col" },
							_react2.default.createElement("img", { src: "/Copertina3.png" })
						),
						_react2.default.createElement(
							"div",
							{ className: "mdl-cell mdl-cell--6-col" },
							...
							_react2.default.createElement(
								"div",
								{ style: { textAlign: 'justify' } },
								"Node.js\xAE \xE8 un runtime Javascript costruito sul motore JavaScript V8 di Chrome. Node.js usa un modello I/O non bloccante e ad eventi, che lo rende un framework leggero ed efficiente ..."
							)
						),
						_react2.default.createElement(
							"div",
							...
							_react2.default.createElement(
								"p",
								null,
								this.state.txOk2 ? _react2.default.createElement(
									"span",
									{ style: { color: 'green' } },
									this.state.txMessage2
								) : _react2.default.createElement(
									"span",
									{ style: { color: 'red' } },
									this.state.txMessage2
							...
							_react2.default.createElement(
								...
								{ className: "mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent",
									onClick: function onClick() {
										return _this3.openPurchase('state2');
									} },
								"Acquista il libro a ",
								formatPrice(this.state.price2),
								" ",
								this.state.loading2 ? '..' : ''
							),
							_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								"div",
								{ style: { textAlign: 'justify' } },
								"Argomenti in breve:- Installare React.js e i suoi strumenti- Creare e controllare le propriet\xE0 degli elementi- Introdurre JSX nel processo di sviluppo- Lavorare con i componenti React- Gestire lo stato ..."
							)
						),
						_react2.default.createElement(
							"div",
