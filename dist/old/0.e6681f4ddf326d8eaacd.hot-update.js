					...
					token: function token(_token) {
						...
						fetch('/charge', {
							...
							body: JSON.stringify({
								...
								customAmount: _this2.state.amount
							})
							...
							_this2.setState({ txOk: true, txMessage: 'Tx riuscita, il download inizierà a breve' });
...
//# sourceMappingURL=0.e6681f4ddf326d8eaacd.hot-update.js.map