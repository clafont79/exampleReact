		...
		_createClass(Main, [{
			...
			value: function toggle(st) {
				...
				if (st === 'state') {
					...
					var _state2 = this.state1,
					    _price = _state2.price,
					    _description = _state2.description,
					    _optionalConsultancy = _state2.optionalConsultancy;
	
					if (_optionalConsultancy == false) {
						this.setState1({
							price: this.state1.price + 2400,
							description: this.state1.description + " + Consulenza",
							optionalConsultancy: true
						});
					} else {
						this.setState1(this.defaultState1);
					}
				}
			}
		}, {
			...
			value: function openPurchase(st) {
				...
				if (st === 'state') {
					...
					desc = this.state1.description;
					amm = this.state1.price;
				}
					...
					token: function token(_token) {
						...
						fetch('/charge', {
							...
							if (st === 'state') {
								...
								_this2.setState({ txOk: true, txMessage1: 'Transazione riuscita, download avviato' });
							}
						}).catch(function (err) {
							_this2.setState({ loading: false });
							if (st === 'state') {
								...
								_this2.setState({ txOk: false, txMessage1: err });
							}
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								"p",
								null,
								this.state1.txOk ? _react2.default.createElement(
									"span",
									{ style: { color: 'green' } },
									this.state1.txMessage1
								) : _react2.default.createElement(
									"span",
									{ style: { color: 'red' } },
									this.state1.txMessage1
...
//# sourceMappingURL=0.d22928690992179c56c1.hot-update.js.map