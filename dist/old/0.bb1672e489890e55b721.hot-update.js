					...
					token: function token(_token) {
						...
						fetch('/charge', {
							...
							if (st === 'state') {
								...
								_this2.setState1({ txOk: true, txMessage: 'Transazione riuscita, download avviato' });
								_this2.setState1({ loading: false });
							}
						}).catch(function (err) {
							...
							if (st === 'state') {
								...
								_this2.setState1({ loading: false });
								_this2.setState1({ txOk: false, txMessage: err });
							}
...
//# sourceMappingURL=0.bb1672e489890e55b721.hot-update.js.map