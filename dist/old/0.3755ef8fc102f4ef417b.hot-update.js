			...
			value: function toggle(st) {
				...
				if (st === 'state') {
					...
					if (_optionalConsultancy == false) {
						this.setState({
							price1: this.state1.price1 + 2400,
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								"Acquista il libro a ",
								formatPrice(this.state1.price1),
								" ",
								this.state1.loading1 ? '..' : ''
							),
							_react2.default.createElement(
								"p",
								null,
...
//# sourceMappingURL=0.3755ef8fc102f4ef417b.hot-update.js.map