...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stripe = __webpack_require__(159);
	...
	try {
		...
		// GET /charge
		router.post('/charge', body, /*#__PURE__*/regeneratorRuntime.mark(function _callee(next) {
			var _this = this;
	
			var filename, getDownload, doCharge, tx, blob;
				...
				while (1) {
					switch (_context.prev = _context.next) {
						...
						case 14:
							...
							this.status = 400;
							console.error("E: " + _context.t0.message);
		...
		router.get('/', /*#__PURE__*/regeneratorRuntime.mark(function _callee2(next) {
...
//# sourceMappingURL=0.ce28ae6de8f39fe3095a.hot-update.js.map